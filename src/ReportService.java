...
/**
 * ReportService — generates live reports from all .txt data files
 * and persists them to reports.txt for CRUD operations.
 *
 * File format (pipe-delimited):
 *   SALES|reportId|totalRevenue|generatedAt
 *   STOCK|reportId|totalItemsInStock|generatedAt
 */
@Service
